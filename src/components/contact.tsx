...
export function Contact() {
  const socialLinks = [
    {
      icon: GithubIcon,
      href: "https://github.com/hyeprlabs",
      label: "GitHub",
    },
    {
      icon: XIcon,
      href: "https://x.com/hyeprlabs",
      label: "X/Twitter",
    },
  ];
      ...
      <div className="z-1 flex h-full flex-col items-center justify-center gap-4 py-24">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {socialLinks.map((link) => (
            <a
              className="flex items-center gap-x-2 rounded-full border bg-linear-to-br from-muted to-background px-3 py-1.5 shadow hover:bg-accent"
              href={link.href}
              key={link.label}
